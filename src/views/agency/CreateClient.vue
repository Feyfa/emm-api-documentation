...
<template>
    <main>
        <section>
            <h1 class="text-3xl font-semibold">Create User Client</h1>
  
            <p class="mt-2">
                This API allows you to create new clients under your agency. By using this endpoint, you can register client information such as their email, full name, and company name. It is specifically designed to streamline the process of adding clients to your agency's system.
            </p>
        </section>
